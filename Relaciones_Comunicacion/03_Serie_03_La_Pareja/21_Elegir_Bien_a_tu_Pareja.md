...
Nadie nos ensena a elegir pareja. Aprendemos a emparejarnos de la misma forma en que aprendemos lo demás: observando a nuestros padres, siendo influidos por la cultura y reaccionando a los sesgos emocionales que el apego temprano instalo en nosotros antes de que pudiéramos elegirlos.

Este libro no te va a decir a quien elegir. Te va a dar las herramientas para que lo veas con más claridad de lo que lo has visto hasta ahora.
...
## Capítulo 3: Atracción vs compatibilidad

La atracción y la compatibilidad son dos variables completamente distintas. Pueden coexistir, pero no necesariamente. Y confundirlas es una de las fuentes más comunes de elecciones de pareja que producen relaciones intensas pero insatisfactorias.

**El Principio de la Atracción como Señal, no como Criterio:** La atracción es información, no una orden de actuar. Dice que algo ha captado tu atención. No dice si esa persona es buena para ti. La compatibilidad, en cambio, es la medida en que dos personas pueden construir una vida compartida satisfactoria: valores alineados, formas de gestionar el conflicto que se complementan, proyectos de vida que tienen espacio el uno para el otro.

Una relación con alta atracción y baja compatibilidad es intensa y a menudo corta. Una con alta compatibilidad y atracción moderada puede ser profundamente satisfactoria a largo plazo. El error más común es priorizar la intensidad de la atracción como medida de la calidad de la elección.

**Ejercicio inmediato:** Para la persona con la que estas actualmente (o la última con la que tuviste una relación significativa), evalua del 1 al 10 la atracción y la compatibilidad por separado. Si la atracción fue significativamente más alta que la compatibilidad, ese es el patron a monitorear en futuras elecciones.

La atracción te dice que la persona te gusta. La compatibilidad te dice si pueden construir algo juntos.
...
El problema es que cada una de estas señales, vista en el contexto del enamoramiento, tiene una explicación racionalizadora que la minimiza: es que aun no me conoce bien, es que tuvo una infancia difícil, es que sus ex le hicieron mucho daño. Las racionalizaciones son reales y pueden ser verdad. Pero no cambian el patron.

**Ejercicio inmediato:** Haz una lista de las señales de alarma que ignoraste en relaciones pasadas. Compara con las que ves actualmente en la relación o persona que te interesa ahora. Si el patron se repite, la racionalización esta activa.

Una señal de alarma que te explicas es una señal de alarma que estas ignorando.

---

## Capítulo 5: Green flags que no valoramos suficiente
...
**Ejercicio inmediato:** Escribe tus cinco valores fundamentales para la vida en pareja. Pide a tu pareja (o a quien te interese) que haga lo mismo por separado. Compare las dos listas sin intentar convencer al otro. Las diferencias que ves son las que tendrían que ser gestionadas conscientemente en la relación.

El amor sin valores comunes produce una guerra de baja intensidad que se llama vida cotidiana.

---

## Capítulo 8: La lista de cualidades y sus trampas

La mayoría de las personas que buscan pareja tienen una lista de lo que quieren: alto, con sentido del humor, inteligente, estable económicamente, buena familia... La lista puede ser muy precisa. Y puede ser completamente irrelevante para la satisfacción relacional real.
...
## Capítulo 10: Tomar una decisión consciente

La elección de pareja no tiene que ser completamente racional. Pero si puede ser más consciente de lo que generalmente es. Más informada por el autoconocimiento, por la comprensión de los propios patrones, y por la disposición a ver lo que esta ahí antes de comprometerse.
...
Elegir bien no significa elegir sin emoción. Significa elegir con los ojos abiertos.

---

## Epílogo

Elena hizo el trabajo. No de golpe. Con el tiempo y algunas relaciones difíciles, empezó a ver sus patrones con más claridad. Empezo a notar cuando estaba eligiendo por familiaridad y cuando estaba eligiendo por compatibilidad real.

La siguiente relación que tuvo fue diferente. No más intensa. Más sólida. No la sensación de que lo había encontrado todo. La sensación de que había encontrado a alguien con quien podía construir algo real.

Eso resultó ser exactamente lo que necesitaba.

---

*Libro 21 de la colección, Libro 1 de 10 de Serie 03: La Pareja.*
