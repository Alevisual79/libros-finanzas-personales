...
Este libro no es un argumento contra la tecnología. Es un argumento para usarla de forma que sirva a las relaciones en lugar de sustituirlas. La distinction importa. Y hacerla requiere algo de esfuerzo deliberado en un mundo diseñado para que no lo hagas.
...
## Capítulo 3: Malentendidos digitales y como resolverlos

Elena y su compañera de trabajo llevan una semana sin hablarse por un mensaje de texto mal interpretado. Elena escribió entendido con un punto final. Su compañera lo leyó como distante y molesto. Elena no se dio cuenta hasta que alguien le dijo que su compañera estaba molesta con ella.

**El Principio de la Resolución en Canal Rico:** Los malentendidos que ocurren en canales pobres (texto, email) se resuelven mejor en canales ricos (en persona, por teléfono). Intentar resolver un malentendido por texto en el mismo canal que lo produjó suele amplificarlo porque el mismo problema de ausencia de tono que creo el malentendido sigue presente en la resolución.
...
## Capítulo 4: Videollamada vs presencial: lo que la camara no captura
...
## Capítulo 5: Redes sociales e imagen relacional
...
**Ejercicio inmediato:** Durante una semana, cada vez que salgas de las redes sociales sintiendote peor que cuando entraste, anota que imagen o publicación lo produjó. Al final de la semana, revisa el patron. Ese patron te dice que contenido o que cuentas te estan haciendo daño de forma sistemática.

Las redes sociales que te hacen sentir menos no son una ventana al mundo. Son un espejo distorsionado de lo que crees que te falta.
...
## Capítulo 7: Conversaciones importantes por texto: cuando y como

Hay conversaciones que ocurren por texto aunque no deberían. Y hay conversaciones que pueden ocurrir por texto perfectamente bien. La clave es saber distinguir.
...
## Capítulo 8: Comunicación asincrona sana

El email, el mensaje de voz y los mensajes que no requieren respuesta inmediata tienen una ventaja real: dan tiempo para pensar antes de responder. El problema es cuando la asincronicidad se convierte en evitación, en disponibilidad selectiva, o en la expectativa de respuesta inmediata que convierte la comunicación asincrona en una fuente de ansiedad.

**El Principio de las Normas Relacionales Claras:** La comunicación asincrona sana requiere que ambas partes tengan expectativas similares sobre los tiempos de respuesta y la disponibilidad. Cuando esas expectativas difieren (uno espera respuesta inmediata, el otro responde cuando puede), la diferencia produce tensión que no tiene que ver con la relación sino con normas no acordadas.

Acordar explicitamente las normas digitales con las personas más importantes de tu vida (cuando es razonable esperar respuesta, que canales se usan para qué tipo de conversación, cuando la falta de respuesta no significa nada sobre la relación) reduce considerablemente la ansiedad digital que muchas relaciones generan.

**Ejercicio inmediato:** Elige la relación en tu vida en que la comunicación digital genera más tensión o malentendidos. Propone una conversación breve sobre las normas: que esperamos el uno del otro en terminos de tiempos de respuesta y de canales. Esa conversación, por incomoda que parezca, resuelve de una vez situaciones que de otra forma se repiten indefinidamente.

Los problemas de comunicación digital casi nunca son sobre la relación. Casi siempre son sobre normas no acordadas.
...
## Capítulo 10: Reglas relacionales digitales que funcionan

Cada pareja, cada familia, cada equipo de trabajo necesita acordar sus propias normas digitales. No hay reglas universales porque los contextos y las necesidades son distintos. Pero hay principios que funcionan en la mayoría de los casos.
...
Las normas digitales no limitan la relación. La protegen de los malentendidos que la tecnología produce cuando se usa sin acuerdo.
