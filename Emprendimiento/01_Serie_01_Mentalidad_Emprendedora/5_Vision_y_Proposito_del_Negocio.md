...
## Capítulo 1: La diferencia entre visión, misión y proposito: tres conceptos que la mayoría confunde

Los tres terminos son reales pero diferentes. Confundirlos produce estrategia vaga y motivación superficial.

**El Principio de la Visión como Destino Aspiracional, la Misión como Razon de Existir, y el Proposito como el Por Que Profundo que da Significado a Ambos:** Jim Collins y Jerry Porras, en Built to Last, desarrollaron el concepto de las empresas visionarias: aquellas que duran décadas y que generan valor significativo más allá de sus fundadores. Su investigación muestra que las empresas visionarias tienen en común una ideología central (que incluye valores fundamentales y un proposito fundamental) que permanece constante mientras las estrategias y las tacticas evolucionan.

La distinción que proponen es: el proposito (el por qué existe la empresa más allá de ganar dinero, la contribución que hace al mundo) es permanente y aspira a ser eterno; la misión (lo que hace la empresa, para quien, y como) es estable pero puede evolucionar; la visión (la imagen concreta del futuro que la empresa quiere construir) es temporal (tiene horizonte temporal) y cambia cuando se alcanza o cuando las circunstancias cambian.
...
## Capítulo 2: El proposito como ventaja competitiva: la investigación que lo demuestra

Marcos ha aprendido que el proposito no es solo motivación interna. Tiene efectos externos medibles.

**El Principio del Proposito como Generador de Ventaja Competitiva Medible en Captación de Talento, Fidelización de Clientes, y Rendimiento Financiero:** La investigación de Raj Sisodia, Jag Sheth, y David Wolfe en Firms of Endearment analizó las empresas que más admiración generan entre todos sus stakeholders (empleados, clientes, proveedores, comunidad, inversores) y encontró que estas empresas (que generalmente tienen un proposito claro más allá del beneficio) superaron al S&P 500 en rendimiento financiero durante el período estudiado.
...
## Capítulo 3: El Simon Sinek del emprendimiento: el circulo de oro aplicado al negocio
...
## Capítulo 4: La visión como herramienta de liderazgo: cómo la visión del fundador da coherencia al equipo
...
La visión que solo entiende el fundador es una visión que solo puede ejecutar el fundador. El que puede ejecutar el equipo es la que el equipo entiende.

---

## Capítulo 5: El proposito y la estrategia: como el por qué informa el como
...
## Capítulo 6: Articular el proposito: el proceso de encontrar el por qué que resuena
...
## Capítulo 9: Cuando la visión cambia: pivotar el proposito sin perder la esencia
...
## Capítulo 10: Integrar la visión y el proposito: de los conceptos a la práctica diaria

Lucia ha llegado a entender que la visión y el proposito no son ejercicios estratégicos anuales. Son los filtros de las decisiones diarias.

**El Principio de la Visión y el Proposito como Activos que se Deprecian si No se Alimentan con Intencionalidad Regular en las prácticas y Decisiones Cotidianas:** La investigación de Gallup sobre la cultura organizacional muestra que la claridad de proposito que los empleados sienten no es el resultado de las declaraciones de misión en los sitios web sino de las decisiones cotidianas de los líderes: cuando el líder sacrifica el proposito ante una presión a corto plazo, la credibilidad del proposito disminuye en toda la organización.

Bill Burnett y Dave Evans proponen que la visión no puede vivir solo en documentos estratégicos: tiene que traducirse en comportamientos concretos que el fundador puede observar cada dia.
...
*Libro 5 de la colección Emprendimiento, Libro 5 de 10 de Serie 01: Mentalidad Emprendedora.*
