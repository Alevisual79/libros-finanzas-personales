...
**Ejercicio inmediato:** Para cada una de las cuatro dimensiones del PsyCap, reflexiona sobre tu nivel actual en el contexto de tu proyecto emprendedor (escala del 1 al 10). La dimensión con la puntuación más baja es la que más impacto puede tener si se desarrolla. Para esa dimensión, identifica una práctica específica de los próximos treinta dias: para la esperanza (la capacidad de encontrar caminos alternativos), práctica el ejercicio de generar deliberadamente tres caminos diferentes hacía tu objetivo cuando el camino principal está bloqueado.
