...
## Capítulo 1: Que es el flujo de caja y por qué es más importante que el beneficio para la supervivencia
...
**Ejercicio inmediato:** Para tu negocio, calcula el gap de flujo de caja del último mes: la diferencia entre el beneficio que has generado (revenue menos costes devengados) y el dinero que realmente ha entrado en tu cuenta bancaria. Si el gap es grande y negativo (el dinero real es mucho menor que el beneficio contable), tienes un problema de flujo de caja activo que necesitas analizar: probablemente clientes que pagan tarde, inversión en activos, o pago de impuestos anticipados.

El negocio que no gestiona el flujo de caja gestiona las sorpresas. Y las sorpresas de liquidez frecuentemente llegan en el peor momento posible.
...
**Ejercicio inmediato:** Para tu negocio, analiza el plazo de cobró real de tus clientes: calcula la media de dias que pasan entre que emites la factura y que recibes el pago para los últimos doce meses. Si ese número supera treinta dias, implementa estas dos acciones esta semana: añade un recordatorio automático de pago a los treinta dias de la emisión de la factura (que puede ser tan simple cómo un email de seguimiento automático de tu herramienta de facturación), y en los nuevos contratos o propuestas, añade un anticipo del treinta o el cincuenta por ciento al inició del trabajo. Esas dos acciones tienen el mayor impacto inmediato en el flujo de caja.

El dia que cobras antes al cliente es un dia que el dinero trabaja para tu negocio en lugar de para el suyo.

---

## Capítulo 3: Los pagos: como gestionar lo que sale para maximizar la liquidez
...
## Capítulo 4: La previsión de flujo de caja: como anticipar los problemas antes de que ocurran
...
**Ejercicio inmediato:** Crea una previsión de flujo de caja para las próximas ocho semanas en una hoja de cálculo simple: en cada semana, anota los cobros que esperas recibir (de facturas ya emitidas y de ventas previstas) y los pagos que tienes comprometidos (facturas de proveedores, nóminas, impuestos). El saldo resultante semana a semana te dirá si hay alguna semana con riesgo de quedarte en negativo. Si la hay, tienes cuatro a ocho semanas para actuar antes de que sea una crisis.

El problema de flujo de caja que ves venir con ocho semanas de antelación tiene solución. El que descubres el viernes que tienes que pagar el lunes, no.

---

## Capítulo 5: El fondo de emergencia del negocio: cuanto tener y donde tenerlo

Lucia ha construido un fondo de emergencia del negocio que le permite dormir tranquila aunque tenga un mal mes.

**El Principio del Fondo de Emergencia del Negocio como El Colchon de Liquidez que Permite al Negocio Sobrevivir a Una Crisis de Revenue o Un Gasto Inesperado sin Necesitar Financiación de Emergencia que Siempre Llega en Malas Condiciones cuando La Necesitas con Urgencia:** El fondo de emergencia del negocio debe ser equivalente a entre dos y seis meses de gastos fijos totales del negocio (no de revenue, sino de gastos). Eso significa que si el revenue cae a cero por cualquier razón durante ese período, el negocio puede seguir pagando sus compromisos mientras se soluciona el problema.

El fondo de emergencia debe estar en una cuenta separada de la cuenta operativa del negocio (para evitar la tentación de usarlo para gastos operativos del dia a dia), de fácil acceso (no en un producto de inversión con penalización por reembolso anticipado), y en un instrumento que genere algo de rentabilidad pero con liquidez inmediata (una cuenta de ahorro de alta rentabilidad o un fondo monetario).
...
## Capítulo 6: La estacionalidad y el flujo de caja: como gestionar los picos y los valles
...
## Capítulo 7: El factoring y las lineas de credito: cuando y como usar financiación de flujo de caja
...
**Ejercicio inmediato:** Si tienes problemas recurrentes de liquidez por clientes que pagan tarde, evalua el coste del factoring para tus principales facturas: pide a tu banco o a un proveedor de factoring el coste de adelantar las facturas de tus dos o tres clientes principales con mayor plazo de pago. Compara ese coste con el impacto real que el retraso de cobró tiene en tu negocio (si necesitas un credito bancario a mayor coste, o si rechazas oportunidades de inversión por falta de liquidez). Si el factoring es más barato que las alternativas, es una herramienta legitima de gestión de flujo de caja.

La herramienta de financiación que adelanta revenue ya ganado es gestión de liquidez. La que financia costes sin revenue suficiente es una señal de alerta.

---

## Capítulo 8: Los impuestos y el flujo de caja: como no tener sorpresas fiscales

Lucia ha aprendido a incluir los impuestos en su planificación de flujo de caja para no tener la sorpresa desagradable en la declaración trimestral.

**El Principio de La Provisión Fiscal como La práctica de Apartar Mensualmente El Porcentaje Estimado de Impuestos sobre El Beneficio Generado para Que Cuando Llegue El Vencimiento Fiscal El Dinero Este Disponible Sin Crear Un Problema de Liquidez:** Los impuestos son uno de los mayores disruptores del flujo de caja del emprendedor que no los planifica: el autonomo en España paga retenciones de IRPF en sus facturas y hace declaraciones trimestrales de IVA e IRPF, pero si no ha provisionado mensualmente esos importes, los vencimientos trimestrales pueden crear problemas serios de liquidez.

La provisión fiscal correcta depende del tipo de impuesto y de la situación de cada negocio, pero como regla general, apartar entre el veinte y el treinta por ciento del beneficio mensual para impuestos (en una cuenta separada de la operativa del negocio) cubre la mayoría de las obligaciones fiscales sin sorpresas.
...
## Capítulo 9: Señales de alarma del flujo de caja: cuando el problema es más serio de lo que parece
...
Cualquiera de esas señales por si sola puede tener una explicación inocua. Dos o más de forma simultánea son una alerta sería que requiere análisis inmediato y acción.
...
## Capítulo 10: Integrar la gestión del flujo de caja: del control reactivo al sistema proactivo
...
**Ejercicio inmediato:** Establece tu sistema de gestión de flujo de caja en cuatro componentes: la previsión semanal (actualizar la previsión de flujo de caja a trece semanas cada lunes en veinte minutos), la gestión de cobros (seguimiento activo de las facturas próximas a vencimiento y de las vencidas), la provisión fiscal (transferencia mensual automática de la provisión fiscal), y la revisión mensual con el gestor (una llamada de quince minutos para revisar la situación y ajustar si es necesario). Esos cuatro componentes, una vez configurados, se mantienen solos con una inversión de tiempo mínima.

El flujo de caja bien gestionado no elimina los problemas del negocio. Garantiza que el negocio tenga el tiempo y el dinero para resolverlos.
...
*Libro 42 de la colección Emprendimiento, Libro 2 de 10 de Serie 05: Dinero y Finanzas del Negocio.*
