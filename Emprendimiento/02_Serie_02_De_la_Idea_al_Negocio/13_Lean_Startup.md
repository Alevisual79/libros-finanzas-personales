...
**El Principio del MVP como el Experimento de Menor Coste que Puede Producir el Mayor Aprendizaje sobre la Hipótesis de Mayor Riesgo del Negocio:** El MVP no es una versión reducida del producto final ni el producto más pequeño que puedes construir. Es la forma más eficiente de probar lo que más importa saber. Los MVPs pueden ser de tipos radicalmente diferentes: un video explicativo (Dropbox), un servicio manual que simula el producto digital (Zappos con zapatos comprados en otras tiendas), una landing page con un boton de compra que lleva a una página de lista de espera, o una sola funcionalidad de un producto que normalmente tiene muchas.

La investigación de Alberto Savoia, en The Right It, muestra que el 80% de los productos fracasan no porque se ejecuten mal sino porque no son los productos correctos. Su metodología de pretotyping (probar antes de construir el prototipo) propone formas aun más rápidas y baratas que el MVP de validar si vale la pena construir el prototipo.

**Ejercicio inmediato:** Para tu idea o tu siguiente iteración del producto, identifica la hipótesis de mayor riesgo (la suposición cuya falsedad destruiria el valor del producto) y diseña el MVP más pequeño que podría probarla. Si la hipótesis es que el cliente pagara X por el producto, el MVP podría ser una landing page con el precio real y un boton de compra que lleva a una lista de espera con nota de reembolso. Si la hipótesis es que el cliente usara el producto diariamente, el MVP podría ser un servicio manual durante dos semanas que simula el producto. El MVP correcto es el que cuesta menos en tiempo y dinero para aprender lo más importante.
