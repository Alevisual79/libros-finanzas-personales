...
Cada tipo de capital tiene caracteristicas diferentes en terminos de tamaño del ticket (cuanto invierten tipicamente), expectativa de retorno, nivel de control que quieren ejercer, y horario de inversión y salida.
...
**El Principio del Crowdfunding como Herramienta de Financiación que Funciona Mejor para Productos con Comunidad Preexistente o para Validar Demanda que Como Fuente Primaria de Capital para Negocios de Servicios:** Las plataformas de crowdfunding como Kickstarter, Indiegogo (para productos) o Crowdcube y Seedrs (para equity) han financiado miles de productos y empresas. Sus caracteristicas: permiten pre-vender el producto antes de producirlo (Kickstarter/Indiegogo), compartir el equity entre muchos pequeños inversores (equity crowdfunding), o conseguir prestamos de muchos prestamistas individuales (crowdlending).
