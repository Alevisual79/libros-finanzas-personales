...
**El Principio del Lanzamiento como Inicio de la Búsqueda de Tracción Sostenible que Requiere Iteración Continua del Producto, el Mensaje, y los Canales hasta Encontrar los que Producen Crecimiento Orgánico:** Gabriel Weinberg y Justin Mares, en Traction, proponen que la búsqueda de tracción sostenible es el trabajo principal del emprendedor en los primeros uno a dos años del negocio. La tracción sostenible (el crecimiento que puede mantenerse y acelerarse sin depender del impulso del lanzamiento) viene de encontrar el canal de adquisición correcto, el mensaje correcto, y el producto correcto para el cliente correcto.
