...
## Capítulo 1: Que es una propuesta de valor y por qué la mayoría son vagas o incorrectas
...
## Capítulo 2: El problema del cliente: el corazón de toda propuesta de valor

Lucia ha aprendido que el error más común de la propuesta de valor es empezar por el producto en lugar de por el problema del cliente.

**El Principio de Empezar por el Problema del Cliente como el Punto de Partida Correcto de la Propuesta de Valor porque el Cliente Solo Compra Cuando Reconoce Su Propio Problema en lo que el Vendedor Describe:** Clayton Christensen en The Innovator's Solution propone el concepto del jobs to be done: los clientes no compran productos o servicios, contratan soluciones para hacer un trabajo que necesitan hacer o para resolver un problema que tienen. La propuesta de valor que articula ese trabajo o ese problema en las palabras del cliente (no del vendedor) tiene inmediatamente más resonancia.
...
## Capítulo 3: La diferenciación: por qué ser diferente importa más que ser mejor
...
## Capítulo 4: La prueba de la propuesta de valor: el testimonio y el caso de éxito

Carlos ha aprendido que la propuesta de valor más poderosa no es la que el dice sobre si mismo sino la que sus clientes dicen sobre el.

**El Principio de la Prueba Social como el Elemento que Convierte una Propuesta de Valor de Afirmación en Evidencia porque el Testimonio del Cliente que Vivio el Resultado Es Más Creible que Cualquier Promesa del Vendedor:** Robert Cialdini en Influence documenta el principio de prueba social: las personas toman decisiones basadas en lo que otros similares a ellas han hecho o experimentado, especialmente en situaciones de incertidumbre. En el contexto de la propuesta de valor, un testimonio específico de un cliente que describe exactamente el resultado que obtuvó (antes y después, problema resuelto, resultado medible) tiene más poder de persuasión que cualquier texto de marketing.
...
## Capítulo 5: La propuesta de valor por segmentos: cuando un solo mensaje no es suficiente

Lucia ha aprendido que negocios con varios tipos de cliente necesitan propuestas de valor diferenciadas para cada uno.

**El Principio de la Propuesta de Valor Segmentada como Necesaria cuando el Negocio Sirve a Multiples Tipos de Cliente con Problemas Diferentes porque Una Propuesta Generica No Resuena Profundamente en Ninguno:** Osterwalder propone que el Business Model Canvas tiene un bloque específico de segmentos de clientes precisamente porque los negocios que sirven a multiples tipos de cliente tienen propuestas de valor diferentes para cada uno: el problema que tiene un director de marketing es diferente del que tiene un autonomo, aunque ambos compren el mismo servicio de consultoria de marketing.
...
## Capítulo 6: El precio como componente de la propuesta de valor

Marcos ha aprendido que el precio no solo es lo que cobras. Es parte de lo que comunicas sobre el valor que ofreces.
...
## Capítulo 7: Comunicar la propuesta de valor: del concepto al texto que convierte
...
## Capítulo 8: La propuesta de valor en las conversaciones de ventas
...
## Capítulo 9: Medir la efectividad de la propuesta de valor

Marcos ha implementado un sistema para medir si su propuesta de valor realmente funciona.
...
## Capítulo 10: Integrar la propuesta de valor: de la declaración a la estrategia

Carlos ha llegado a entender que la propuesta de valor no es un texto. Es la estrategia central de su negocio.

**El Principio de la Propuesta de Valor como Estrategia Central del Negocio que Guia todas las Decisiones de Producto, Precio, Canal, y Comunicación porque Todo lo que Hace el Negocio Debe Ser Coherente con el Valor que Promete:** Michael Porter propone que la estrategia de una empresa no es una lista de actividades sino la elección coherente de lo que hace y lo que no hace en función del posicionamiento que quiere tener. La propuesta de valor es la manifestación de esa elección estratégica: define para quien se trabaja, que se les promete, y cómo se les entrega.
...
*Libro 23 de la colección Emprendimiento, Libro 3 de 10 de Serie 03: Marketing y Ventas.*
