...
La clave del seguimiento efectivo no es la persistencia del emprendedor sino el valor que aporta en cada contacto: cada seguimiento debe tener un motivo (compartir un articulo relevante, enviar un caso de éxito aplicable, o informar de un cambio en la oferta) que añada valor al cliente en lugar de simplemente recordarle que existe la oferta.
