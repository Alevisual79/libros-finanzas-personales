...
## Capítulo 1: Por qué no cambiamos: el modeló de la inmunidad al cambio
...
**El Principio del Cambio como Proceso Bidireccional donde el Comportamiento Cambia los Pensamientos Tanto como los Pensamientos Cambian el Comportamiento:** La terapia cognitivo-conductual (TCC) propone que los pensamientos, emociones, y comportamientos estan interconectados y se influyen mutuamente: cambiar los pensamientos produce cambios en las emociones y el comportamiento, y cambiar el comportamiento produce cambios en los pensamientos y las emociones.

La investigación de Neil Jacobson y colegas sobre la activación conductual (un componente de la TCC para la depresión) muestra que el cambio de comportamiento (aumentar la frecuencia de actividades positivas) puede producir cambio de pensamiento y estado emocional sin necesidad de abordar los pensamientos directamente primero. A veces el camino más corto al cambio es actuar diferente antes de pensar diferente.

**Ejercicio inmediato:** Para un patron de pensamiento negativo que quieres cambiar, prueba primero la activación conductual: identifica una acción específica incompatible con ese pensamiento y realizala antes de intentar cambiar el pensamiento. Si el pensamiento es no tengo energía para nada, la acción podría ser diez minutos de caminata. La acción frecuentemente cambia el pensamiento más rápido que el trabajo directo sobre el pensamiento.

A veces el camino más corto al pensamiento que quieres es hacer primero lo que ese pensamiento dice que no puedes hacer.
...
## Capítulo 5: El poder de la identidad en el cambio: ser antes que hacer

Ruben ha notado que los cambios de comportamiento que más han durado en su vida son los que han venido acompanados de un cambio en cómo se ve a si mismo.
...
## Capítulo 6: La recaida como parte del proceso: aprender a caer bien

Elena ha abandonado sus propositos de cambio después de la primera recaida. La investigación dice que la recaida es esperable.

**El Principio de la Recaida como Componente Normal del Proceso de Cambio, no como Senal de Fracaso:** La investigación de Marlatt y Gordon sobre la prevención de recaidas muestra que la recaida es la norma, no la excepción, en el cambio de comportamiento: la mayoría de las personas que intentan cambiar un comportamiento significativo tendrán al menos una recaida. El problema no es la recaida sino la interpretación de la recaida.
...
## Capítulo 7: El apoyo social como herramienta de cambio

Isabel sabe que los cambios que ha mantenido en el largo plazo siempre han tenido algun componente social.

**El Principio del Apoyo Social como Multiplicador del éxito en el Cambio de Comportamiento a Largo Plazo:** La investigación de John Norcross y colegas sobre las personas que cambian de forma exitosa vs. las que no lo consiguen muestra que el apoyo social (tener personas en el entorno que apoyan activamente el cambio) es uno de los predictores más robustos del éxito en el cambio de comportamiento a largo plazo. El apoyo puede incluir: companieros de accountability (personas que comprueban el progreso), modelos de rol (personas que ya tienen el comportamiento deseado), y cambio de normas del grupo (pertenecer a comunidades donde el comportamiento deseado es la norma).
...
## Capítulo 9: El cambio lento: por qué las transformaciones profundas requieren tiempo
...
**Ejercicio inmediato:** Para el cambio que quieres realizar, pregúntate: ¿cuanto tiempo creo que debería tardar este cambio? Luego multiplica esa estimación por tres o cuatro para tener una estimación más realista. La mayoría de los fracasos en el cambio no son fracasos del proceso sino fracasos de las expectativas de tiempo: las personas abandonan un proceso que funcionaria si le dieran más tiempo.

El cambio que abandonas porque tarda demasiado era frecuentemente el que estaba a punto de llegar.

---

## Capítulo 10: Integrando el cambio: de los intentos aislados a una vida de aprendizaje

Isabel ha llegado a entender que el cambio no es un proyecto con un principio y un fin. Es una práctica de por vida.

**El Principio del Cambio como práctica Continua que Requiere Aprender a Aprender de Uno Mismo:** Carol Dweck y colegas muestran que el mindset de crecimiento (la creencia de que las capacidades pueden desarrollarse con esfuerzo y práctica) no solo predice el éxito en el aprendizaje académico sino en el cambio personal a lo largo de la vida. Las personas con mindset de crecimiento interpretan los fracasos en el cambio como información (que puedo aprender de esto?) en lugar de como veredictos (esto demuestra que no puedo).
...
*Libro 91 de la colección psicología Aplicada, Libro 1 de 10 de Serie 10: Crecimiento Personal.*
