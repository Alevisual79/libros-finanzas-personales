...
Los tipos más comunes de fobias específicas son: animales (arañas, serpientes, perros, insectos), entorno natural (alturas, tormentas, agua), sangre-inyección-daño (con la particularidad neurologica de activar vasovagal en lugar de hiperactivación), situacional (aviones, ascensores, espacios cerrados), y otras (por ejemplo, vomitar, atragantarse, ruidos fuertes). Cada tipo tiene particularidades específicas que informan el tratamiento.
