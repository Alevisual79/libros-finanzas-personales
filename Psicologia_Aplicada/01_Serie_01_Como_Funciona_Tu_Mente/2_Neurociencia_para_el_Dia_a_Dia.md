...
A diferencia de una computadora que funciona igual si la usas dos horas o veinte, el cerebro tiene rendimientos decrecientes marcados, estados óptimos y suboptimos, y ciclos naturales de alta y baja capacidad que ocurren tanto a lo largo del dia (ritmos circadianos) como dentro de cada período de trabajo (ciclos ultradianos de aproximadamente noventa minutos).

**Ejercicio inmediato:** Durante los próximos tres dias, registra tu nivel de alerta y productividad cada hora en una escala del uno al diez. Probablemente emergeran patrones de picos y valles que se repiten. Esos patrones son tu cerebro, no tu carácter, y se pueden usar estratégicamente.

Tu cerebro tiene un ritmo natural. Ignorarlo no lo cancela. Solo hace que trabajes contra el.

---

## Capítulo 2: Neuroplasticidad: el cerebro que se transforma

Isabel leyó que el cerebro adulto no puede cambiar, que las neuronas que se pierden no se recuperan, que después de cierta edad el aprendizaje es fundamentalmente más limitado. Todo esto es cierto en parte y profundamente enganoso en lo esencial: el cerebro adulto es extraordinariamente plastico durante toda la vida.
...
Tu cerebro no es tu destino. Es el resultado de cómo lo has usado hasta ahora, y el punto de partida para lo que hagas a continuación.

---

## Capítulo 3: El sueño es cuando tu cerebro trabaja de verdad
...
## Capítulo 5: Ejercicio físico: la droga perfecta para el cerebro

Ruben ha intentado mejorar su concentración y memoria con suplementos, aplicaciones de entrenamiento cognitivo, y técnicas de meditación. Ninguno ha tenido efectos comparables al más efectivo potenciador cognitivo que existe y que es completamente gratuito: el ejercicio físico aerobico regular.

**El Principio del Movimiento como Fertilizante Cerebral:** El ejercicio físico aerobico, especialmente el de intensidad moderada como caminar rápido, correr o nadar, aumenta la producción de BDNF (factor neurotrofico derivado del cerebro), una proteina que John Ratey, psiquiatra de Harvard, llama el fertilizante del cerebro. El BDNF estimula la neurogenesis (formación de nuevas neuronas en el hipocampo), fortalece las conexiones sinopticas existentes y protege las neuronas del daño oxidativo.

Los efectos cognitivos del ejercicio aerobico regular incluyen mejoras documentadas en memoria de trabajo, función ejecutiva, velocidad de procesamiento y regulación emocional. Una sesión de treinta minutos de ejercicio moderado produce mejoras cognitivas inmediatas que duran varias horas. La práctica regular durante semanas produce cambios estructurales medibles en el volumen del hipocampo y la corteza prefrontal. El ejercicio físico tiene efectos sobre el cerebro que ninguna pastilla ni aplicación ha logrado replicar.

**Ejercicio inmediato:** Esta semana, antes de una tarea cognitiva importante, prueba hacer treinta minutos de ejercicio aerobico moderado. Observa si hay diferencia en tu claridad mental y capacidad de concentración comparado con dias sin ejercicio previo. Los datos de tu propio cerebro son el argumento más convincente.

El ejercicio físico no es lo que haces para tener buen cuerpo. Es lo que haces para tener buen cerebro.
...
La meditación no es espiritualidad. Es gimnasia para el prefrontal.
...
**Ejercicio inmediato:** Esta semana, programa al menos dos interacciones sociales de calidad (no mensajes de texto ni redes sociales) con personas cuya forma de pensar te estimule. Conversaciones reales, presenciales o por video, donde haya intercambio genuino de ideas. Observa si afecta a tu claridad mental en las horas siguientes.

Tu cerebro no funciona en aislamiento. Fue diseñado para funcionar en conversación.
...
**Ejercicio inmediato:** Durante un dia, silencia todas las notificaciones de tu teléfono y activa el modo no molestar excepto para llamadas. Observa el impulso de revisar el teléfono sin notificación que lo provoque. Ese impulso es el circuito de dopamina buscando su siguiente dosis. Reconocerlo es el primer paso para no obedecerlo automáticamente.

Las aplicaciones no te enganchan por accidente. Te enganchan por diseño deliberado de ingenieros que entienden tu cerebro mejor que tu.

---

## Capítulo 10: Un usuario más inteligente de tu propio cerebro

Elena, Ruben e Isabel comparten una problema común: llevan toda su vida usando su cerebro sin saber como funciona. Tomando decisiones sobre cuando dormir, como manejar el estrés, que comer, como organizar su trabajo, basandose en hábitos culturales o suposiciones que a menudo contradicen directamente lo que la neurociencia sabe sobre el funcionamiento óptimo del cerebro.

**El Principio del Conocimiento como Leverage Cognitivo:** Entender como funciona el cerebro no convierte a nadie en superhuman cognitivo. Pero si produce mejoras reales y sostenibles porque permite tomar decisiones sobre el uso del cerebro que son congruentes con como este funciona realmente. Andrew Huberman, neurocientífico de Stanford, enfatiza que las intervenciones más poderosas para la función cerebral son frecuentemente las más simples: sueño consistente, ejercicio regular, exposición a luz natural por la mañana, gestión del estrés cronico. No porque sean fáciles, sino porque alinean el uso del cerebro con su biología.
...
*Libro 2 de la colección psicología Aplicada, Libro 2 de 10 de Serie 01: Como Funciona Tu Mente.*
