...
Para entender hacía donde puede ir el cerebro humano con la tecnología, vale la pena entender de dónde viene: un organo diseñado por la evolución para sobrevivir en entornos muy distintos al que habita hoy.

**El Principio del Desfase Evolutivo:** El cerebro humano moderno es esencialmente el mismo que el de nuestros ancestros de hace doscientos mil años. Fue diseñado por la selección natural para resolver los problemas de supervivencia en la sabana africana: detectar depredadores, gestionar relaciones sociales complejas en grupos de ciento cincuenta personas, evaluar recursos y amenazas en entornos físicos inmediatos. Ahora ese mismo cerebro intenta operar en un mundo urbano hipercomplejo, con tecnología que cambia cada década, con información que supera cualquier capacidad de procesamiento individual, y con amenazas que frecuentemente son abstractas y estadisticas en lugar de físicas e inmediatas.
...
**El Principio de la Interfaz Neural como Salto Cualitativo:** Las tecnologías de interfaz cerebro-computadora actuales estan en un estado comparables al de los primeros ordenadores personales en los años setenta: funcionales pero rudimentarios, con aplicaciones iniciales específicas que no reflejan el potencial a largo plazo. Karl Deisseroth, neurocientifico de Stanford que desarrollo la optogenetica, y Miguel Nicolelis, neurocientifico de Duke que ha demostrado control de dispositivos externos mediante actividad cerebral en primates, representan la vanguardia de lo que es biologicamente posible en la interfaz entre neuronas y maquinas.
...
El cerebro de los noventa que quieres tener se construye con los habitos de los treinta que tienes ahora.
