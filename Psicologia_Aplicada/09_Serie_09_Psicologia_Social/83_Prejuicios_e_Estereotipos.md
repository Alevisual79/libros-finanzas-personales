...
## Capítulo 1: Por qué el cerebro categoriza: la función adaptativa de los estereotipos
...
## Capítulo 2: El sesgo implícito: cuando el prejuicio opera sin conciencia
...
## Capítulo 3: El estereotipo en acción: como afecta el comportamiento

Isabel ha visto en su empresa como los estereotipos de genero afectan las decisiones de promoción incluso en managers que se identifican como igualitarios.

**El Principio del Estereotipo en Acción como Sesgo que Afecta Decisiones sin Conciencia Deliberada:** La investigación de Cecilia Ridgeway sobre las expectativas de estatus muestra que los estereotipos de genero, raza, y edad producen expectativas de competencia que afectan las evaluaciones de rendimiento de forma sistemática: el mismo trabajo evaluado como de un hombre es calificado como más competente que el evaluado como de una mujer, el mismo CV con un nombre afroamericano recibe menos respuestas que el mismo CV con nombre anglosajon (investigación de Bertrand y Mullainathan, 2004).
...
## Capítulo 5: Los sesgos de genero: investigación y matices

Elena ha experimentado sesgos de genero en su carrera. La investigación es extensa y, en algunos puntos, más compleja de lo que la narrativa pública sugiere.

**El Principio de los Sesgos de Genero como Reales pero Heterogeneos en sus Efectos:** La investigación sobre sesgo de genero en el trabajo muestra efectos robustos en algunas áreas: los CV identicos son evaluados más positivamente cuando se presentan con nombre masculino en campos STEM (investigación de Moss-Racusin y colegas, 2012); las mujeres que exhiben liderazgo assertivo son penalizadas más que los hombres por el mismo comportamiento (penalización por backlash); y las madres reciben penalización en evaluaciones de competencia que los padres no reciben.

Sin embargo, la investigación también muestra que los sesgos de genero no son uniformemente negativos para las mujeres en todos los contextos: en evaluaciones de calentamiento social (amabilidad, cooperación), las mujeres frecuentemente son evaluadas más positivamente. La complejidad del sesgo de genero no niega sus efectos negativos reales sino que los situa en su textura específica.

**Ejercicio inmediato:** Si identificas sesgos de genero en tu entorno (evaluaciones diferenciadas, expectativas diferenciadas, lenguaje diferenciado), reflexiona sobre el nivel donde puedes actuar: como individuo (cambiar tu propio comportamiento evaluativo), como miembro del equipo (senalar el sesgo cuando lo ves en otros), o como líder (implementar procesos que reduzcan el sesgo sistemáticamente). Cada nivel tiene su estrategia específica.

El sesgo de genero que solo nombras sin actuar sobre el es un problema que reconoces pero no ayudas a resolver.

---

## Capítulo 6: La reducción del prejuicio: lo que la investigación muestra que funciona

Ruben quiere reducir sus propios sesgos. La investigación tiene resultados que son a la vez alentadores y moderados.

**El Principio de las Intervenciones de Reducción del Prejuicio como Efectivas pero específicas en Alcance:** La investigación de la teoria del contacto de Gordon Allport propone que el contacto entre grupos reduce el prejuicio bajo condiciones específicas: igualdad de estatus entre los grupos en el contexto de contacto, objetivos comunes, cooperación intergrupal, y apoyo de las autoridades institucionales. La meta-análisis de Thomas Pettigrew y Linda Tropp que integra 515 estudios confirma que el contacto bajo estas condiciones reduce el prejuicio de forma robusta.
...
## Capítulo 7: Los sesgos de edad: el edadismo como prejuicio normalizado

Isabel, a sus cincuenta y dos años, ha empezado a notar que el edadismo es un sesgo normalizado que raramente se reconoce como tal.

**El Principio del Edadismo como Sesgo sistemático con Consecuencias Reales Frecuentemente Invisibles:** La investigación de Todd Nelson y colegas sobre el edadismo muestra que las actitudes negativas hacía las personas mayores (y, en algunos contextos, hacía los jóvenes) son frecuentes, aceptadas socialmente, y rara vez cuestionadas de la misma forma que otros prejuicios. El edadismo en el trabajo se manifiesta en menor tasa de contratación de personas mayores (incluso con igual cualificación), menor inversión en su formación, y menor probabilidad de ser seleccionados para proyectos de alta visibilidad.
...
## Capítulo 8: El sesgo de confirmación y los estereotipos: un ciclo que se autoalimenta

Ruben nota que cuando tiene una expectativa sobre una persona, frecuentemente encuentra evidencia que la confirma. No es casualidad.

**El Principio del Sesgo de Confirmación como Mecanismo que Mantiene los Estereotipos a pesar de la Evidencia Contraria:** La investigación de Peter Wason y colegas sobre el sesgo de confirmación muestra que las personas buscan activamente información que confirme sus creencias previas y evitan o minimizan la información que las contradice. Cuando este sesgo se aplica a los estereotipos, produce que las excepciones al estereotipo sean descartadas (ese es diferente, no es como los de su grupo) mientras que los ejemplos que lo confirman se almacenan y recuerdan con mayor facilidad.

La investigación de Mark Snyder sobre la confirmación conductual muestra que los estereotipos pueden producir que la persona estereotipada se comporte de formas que confirman el estereotipo: si se trata a alguien como si fuera incompetente, puede comportarse de forma menos competente de lo que sería en otro contexto.

**Ejercicio inmediato:** Para una creencia que tienes sobre una persona o grupo, práctica el contrafactual: busca activamente ejemplos que contradigan esa creencia. No para eliminarla automáticamente sino para asegurarte de que tu evaluación tiene en cuenta la evidencia completa y no solo la que confirma lo que ya crees.

La creencia que solo busca su propia confirmación no aprende. Solo acumula lo que ya sabía.

---

## Capítulo 9: Estructuras que reducen el sesgo sistemático

Isabel quiere implementar cambios en los procesos de recursos humanos que reduzcan el sesgo sistemático.

**El Principio de los Procesos Estructurados cómo la Intervención más Efectiva contra el Sesgo sistemático:** La investigación de Iris Bohnet en Harvard sobre lo que funciona para reducir el sesgo de genero en las organizaciones muestra que las intervenciones más efectivas no son las que intentan cambiar las actitudes individuales (talleres de sensibilización) sino las que cambian los procesos estructurales (evaluaciones ciegas, criterios de evaluación explicitados antes de la evaluación, criterios numericos en lugar de impresiones globales).
...
## Capítulo 10: Vivir con la imperfección cognitiva: hacía una mente más justa
...
Isabel cambio los formularios de evaluación de rendimiento. Antes, los managers evaluaban con una calificación global. Ahora, evaluan con criterios específicos previamente definidos antes de ver los nombres. La correlación entre genero y evaluación, que era estadisticamente significativa en el sistema anterior, desaparecio en el nuevo. Los managers no habían cambiado. Sus sesgos probablemente tampoco. Pero el proceso ya no les dejaba espacio para que esos sesgos se expresaran en la evaluación. No fue una solución perfecta. Pero fue una solución real.

---

*Libro 83 de la colección psicología Aplicada, Libro 3 de 10 de Serie 09: psicología Social e Influencia.*
