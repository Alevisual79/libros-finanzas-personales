...
La frase el cuerpo lleva la cuenta (the body keeps the score) es el título del libro más influyente de Bessel van der Kolk y resume una comprensión fundamental del trauma: que la experiencia traumatica se almacena no solo en la memoria cognitiva sino en el cuerpo mismo, en las tensiones musculares, en los patrones respiratorios, en las reacciones viscerales.
...
**El Principio del SE como Proceso de Completar la Respuesta Interrumpida:** Peter Levine desarrollo el Somatic Experiencing (SE) observando como los animales en estado salvaje completan el ciclo de la respuesta de estres a traves del movimiento y la descarga (el temblor que sacude el cuerpo después del peligro) y raramente desarrollan sintomas cronicos del trauma. Propone que los seres humanos desarrollan trauma cuando este ciclo de completar la respuesta es interrumpido, y que el proceso de sanación implica completar esa respuesta interrumpida a traves de movimientos muy pequeños y graduales.
