...
## Capítulo 1: El burnout: cuando el trabajo consume lo que eres
...
**Ejercicio inmediato:** Evalua cuantas de las seis áreas de desajuste de Maslach reconoces en tu trabajo actual. Si tres o más áreas tienen desajuste significativo, el riesgo de burnout es alto y merece atención activa, sea mediante cambios en el trabajo o mediante estrategias de afrontamiento.

El burnout no lo produces tu solo. Es el resultado de un desajuste entre lo que el trabajo exige y lo que el sistema te da para afrontarlo. Y ese desajuste puede reducirse.

---

## Capítulo 2: Los límites en el trabajo: la habilidad que más cuesta y más protege
...
## Capítulo 3: El control percibido como factor de salud mental en el trabajo
...
## Capítulo 4: La recuperación como parte del rendimiento: no es el contrario del trabajo
...
**Ejercicio inmediato:** Esta semana, experimenta con descansos de cinco a diez minutos cada noventa minutos durante la jornada laboral (la técnica Pomodoro aplicada en ciclos largos). Usa esos descansos para desconectar completamente del trabajo: una caminata breve, estiramiento, o simplemente mirar por la ventana. Evalua al final de la semana si la calidad del trabajo en los períodos de actividad ha cambiado.

El tiempo que dedicas a recuperarte no lo robas al trabajo. Se lo devuelves en forma de mejor rendimiento en el tiempo que trabajas.

---

## Capítulo 5: Las relaciones laborales: la variable que más afecta al bienestar en el trabajo

Ruben tiene un cliente que le produce una tensión cronica que no ha resuelto. Esa relación es la mayor amenaza a su salud mental en el trabajo.

**El Principio de las Relaciones Laborales como Determinante Principal del Bienestar en el Trabajo:** La investigación de Gallup en más de 30 millones de trabajadores en todo el mundo muestra que la variable que más predice el compromiso y el bienestar en el trabajo es tener un jefe o compañero que se preocupa genuinamente por el trabajador como persona. Más que el salario, las condiciones, o el tipo de trabajo, la calidad de las relaciones en el entorno laboral determina la experiencia diaria del trabajo.
...
La investigación de Gordon Flett sobre el perfeccionismo socialmente prescrito (la creencia de que otros esperan la perfección) es especialmente relevante en entornos laborales competitivos: produce mayor ansiedad que el perfeccionismo auto-orientado porque la fuente del estandar es externa y no controlable.

**Ejercicio inmediato:** Para el próximo trabajo que entregues, práctica el estandar del suficientemente bueno: identifica cual es el nivel de calidad que cumple con los requisitos reales de la tarea (no con los requisitos de tu crítico interno perfecta) y detente cuando llegues a ese nivel. Nota la incomodidad que produce. Esa incomodidad es el perfeccionismo en acción, y es completamente manejable una vez que la identificas.

El trabajo suficientemente bueno que se completa es más valioso que el trabajo perfecto que nunca se entrega.

---

## Capítulo 7: El sentido en el trabajo: no siempre se puede elegir, pero se puede construir

Ruben hace trabajo que a veces le parece sin sentido. Tiene que facturar, pero hacer solo trabajo sin sentido tiene un coste para la salud mental.

**El Principio del Job Crafting como Via para Construir Sentido en el Trabajo:** Amy Wrzesniewski y Jane Dutton de la Universidad de Yale desarrollaron el concepto de job crafting: la modificación proactiva de los aspectos del trabajo (las tareas, las relaciones, o el significado cognitivo) para hacerlo más alineado con los valores, fortalezas, y sentido de identidad.
...
## Capítulo 9: Pedir ayuda en el trabajo cuando la salud mental falla
...
## Capítulo 10: Disenar un trabajo que sea sostenible a largo plazo

Isabel ha llegado a entender que el trabajo que tiene ahora no puede ser el trabajo que tendrá en diez años con el mismo nivel de exigencia. Algo tiene que cambiar.

**El Principio de la Sostenibilidad como Criterio Central para el Diseno del Trabajo:** Cal Newport, en Deep Work, propone que el trabajo de alta calidad requiere condiciones que el ritmo de trabajo de hiperconectividad hace imposibles: períodos de concentración profunda sin interrupciones, recuperación suficiente entre períodos de alta demanda cognitiva, y alineación entre las tareas y las capacidades más desarrolladas.
...
*Libro 65 de la colección psicología Aplicada, Libro 5 de 10 de Serie 07: Depresión y Bienestar Mental.*
