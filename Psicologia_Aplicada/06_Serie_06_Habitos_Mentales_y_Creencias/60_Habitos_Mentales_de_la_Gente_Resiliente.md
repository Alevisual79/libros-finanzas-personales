...
## Capítulo 1: La resiliencia no es un rasgo, es un conjunto de prácticas
...
**El Principio de la Flexibilidad Cognitiva como Recurso Central de la Resiliencia:** La investigación de George Bonanno y Maren Westphal sobre los mecanismos de la resiliencia identifica la flexibilidad cognitiva como uno de los predictores más robustos: la capacidad de cambiar la perspectiva sobre una situación cuando la perspectiva inicial no es funcional para adaptarse.
...
## Capítulo 3: El sentido de coherencia: encontrar significado en lo que ocurre
...
## Capítulo 4: La autoeficacia generalizada: creer que puedes afrontar lo que venga
...
## Capítulo 5: La aceptación activa: soltar lo que no puedes cambiar sin rendirte

Isabel tiene dificultades para distinguir cuando luchar y cuando soltar. Esta distinción es una de las habilidades centrales de la resiliencia.

**El Principio de la Aceptación Activa como Alternativa a la Evitación y a la Rendición:** Marsha Linehan distingue entre la aceptación radical (aceptar completamente la realidad tal como es, incluyendo lo que no puede cambiarse) y la rendición (dejar de intentar cambiar lo que si puede cambiarse). La aceptación activa acepta los hechos tal como son mientras sigue actuando sobre lo que puede cambiarse.

La Oración de la Serenidad, atribuida al teologo Reinhold Niebuhr, captura esta distinción: serenidad para aceptar lo que no puedo cambiar, coraje para cambiar lo que puedo, y sabiduría para saber la diferencia. La sabiduría de la distinción es la habilidad más difícil y más valiosa de la resiliencia.

**Ejercicio inmediato:** Para la dificultad actual más importante, aplica la distinción: divide los elementos de la situación en dos columnas: lo que esta bajo tu influencia y lo que no. Para la primera columna, haz un plan de acción. Para la segunda, práctica la aceptación radical: esto existe, no puedo cambiarlo, pero puedo elegir como relacionarme con ello.

Luchar contra lo que no puede cambiarse agota los recursos que necesitas para cambiar lo que si puede.

---

## Capítulo 6: El optimismo realista: esperar lo mejor sin ignorar lo peor

Ruben tiene tendencia al pesimismo que justifica como realismo. Pero las personas resilientes que conoce tienen algo que no es ni pesimismo ni optimismo ingenuo.

**El Principio del Optimismo Realista como Posición Adaptativa:** Martin Seligman distingue el optimismo aprendido (el estilo explicativo que atribuye los eventos negativos a causas temporales y específicas) del pesimismo aprendido (que los atribuye a causas permanentes y pervasivas). Pero también distingue el optimismo ingenuo (negar los riesgos reales) del optimismo realista (mantener expectativas positivas sobre el futuro mientras se reconocen los obstaculos reales y se planifica para ellos).

La investigación de Gabriele Oettingen sobre el wishful thinking muestra que la fantasia pura sobre el éxito sin reconocimiento de los obstaculos produce peores resultados que la combinación de expectativas positivas con reconocimiento realista de los obstaculos y planificación específica (el método WOOP: Wish, Outcome, Obstacle, Plan).

**Ejercicio inmediato:** Para un objetivo que te importa y donde el progreso te preocupa, práctica el WOOP: cual es el objetivo (Wish), cual sería el mejor resultado (Outcome), cual es el obstaculo principal que se interpone (Obstacle), y que plan tienes para ese obstaculo (Plan). Esta combinación de expectativa positiva y realismo obstaculizador es el corazón del optimismo realista.

El optimismo que niega los obstaculos es una trampa. El que los incluye en el plan es un recurso.

---

## Capítulo 7: Las relaciones como recurso de resiliencia

Elena ha notado que los momentos en que su resiliencia fue mayor fueron también los momentos en que no estaba sola.
...
## Capítulo 8: El humor y la levedad: tomar la vida en serio sin tomarse demasiado en serio
...
## Capítulo 10: Construir la resiliencia antes de necesitarla
