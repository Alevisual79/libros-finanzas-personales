...
## Capítulo 1: Que es realmente la autoestima

La autoestima se confunde frecuentemente con la arrogancia, con el narcisismo, o con el simple hecho de sentirse bien consigo mismo en un momento dado. La autoestima real es algo más preciso y más exigente.

**El Principio de la Autoestima como Evaluación Global del Yo:** Nathaniel Branden, psicologo que dedicó su carrera al estudio de la autoestima, la define cómo la disposición a experimentarse como competente para manejar los desafios basicos de la vida y como merecedor de felicidad. Esta definición tiene dos componentes que Branden considera inseparables: el sentido de eficacia (creo que puedo) y el sentido de merecimiento (creo que valgo). Una persona puede tener alto sentido de eficacia y bajo sentido de merecimiento (logra cosas pero no cree que merezca disfrutarlas) o viceversa. La autoestima genuina requiere ambos en proporción suficiente.

Morris Rosenberg, sociologo que desarrollo la Escala de Autoestima de Rosenberg (la más utilizada en investigación), la define cómo una actitud positiva o negativa hacía el yo. Esta actitud no es un sentimiento puntual sino un patron relativamente estable de evaluación del propio valor, aunque es modificable con el tiempo y la experiencia.

**Ejercicio inmediato:** Distingue entre tu sentido de eficacia (que tan competente te sientes para manejar lo que la vida te pone delante) y tu sentido de merecimiento (que tan merecedor te sientes de cosas buenas). Da a cada uno una puntuación del uno al diez. La brecha entre las dos puntuaciones senala frecuentemente el componente de autoestima que más trabajo necesita.

La autoestima no es lo que piensas de ti mismo cuando las cosas van bien. Es lo que piensas cuando van mal.
...
La autoestima no la construyen tus logros. La construye como te comportas contigo mismo en el proceso de intentarlos.
...
## Capítulo 4: Autoestima e infancia: de dónde viene lo que sientes sobre ti

Isabel puede rastrear muchos de sus patrones de autoestima baja hasta mensajes que recibio en la infancia sobre su valor, su competencia y su merecimiento. No lo hace para culpar a nadie. Lo hace para entender de dónde viene la voz que la limita.

**El Principio del Aprendizaje Temprano del Valor Propio:** Carl Rogers, psicologo humanista, propuso que el yo se desarrolla en la infancia a traves de la interacción con las figuras de cuidado. Cuando el amor y la aceptación son incondicionales (eres valioso independientemente de como te comportes), el niño desarrolla un sentido de valor estable. Cuando el amor es condicional (eres valioso cuando te comportas bien, logras cosas, o cumples las expectativas), el niño desarrolla un sentido de valor condicionado al rendimiento y la aprobación.
...
Tratar bien a tu cuerpo es la forma más basica de decirte a ti mismo que mereces ser bien tratado.

---

## Capítulo 6: Autoestima y acción: el camino de los logros pequeños

Elena espera sentirse mejor consigo misma antes de actuar. Quiere tener la autoestima suficiente para lanzar el proyecto, hacer la llamada, salir a conocer gente. Pero la investigación sobre cómo se construye la autoestima sugiere que la causalidad es frecuentemente inversa.

**El Principio de la Autoestima Construida desde la Acción:** Albert Bandura, en su teoria de la autoeficacia, documenta que el mejor predictor del sentido de competencia futura es el historial de éxitos pasados en tareas similares: la autoestima se construye fundamentalmente haciendo cosas, no pensando sobre hacerlas. Esto crea un problema cuando la baja autoestima impide la acción (que impide construir autoestima), pero también indica la salida: acciones pequeñas y exitosas, deliberadamente elegidas para estar en el límite de la zona de confort, construyen el historial de competencia que genera autoestima real.

Barbara Fredrickson, con su teoria del ampliar-y-construir, muestra que las emociones positivas (incluyendo el orgullo que produce el logró) amplian el repertorio de pensamientos y acciones disponibles, produciendo un ciclo ascendente que se opone al ciclo descendente de la baja autoestima. La acción no requiere que ya tengas la autoestima que necesitas. Genera la autoestima que necesitas.

**Ejercicio inmediato:** Identifica una acción pequeña que has estado posponiendola porque no te sientes suficientemente preparado, seguro o valioso. Completala esta semana, no cuando te sientas listo. La experiencia de haberlo hecho, aunque imperfectamente, construye más autoestima real que cualquier trabajo de preparación previa.

No actuas porque tienes autoestima. Tienes autoestima porque actuas.

---

## Capítulo 7: Los límites como fundamento de la autoestima

Isabel acepta compromisos que no quiere asumir, dice si cuando quiere decir no, y se adapta constantemente a lo que cree que los demás esperan de ella. Esta falta de límites, que percibe como generosidad o flexibilidad, es en realidad uno de los factores que más erosiona su autoestima.

**El Principio de los Límites como Autorespeto en Acción:** Nathaniel Branden propone que la autoafirmación (uno de los seis pilares) incluye específicamente la capacidad de reconocer las propias necesidades y defenderlas, de decir no cuando la propia integridad lo requiere, y de tratar con honestidad las propias reacciones ante el comportamiento de los demás. Cada vez que se viola un propio límite (se acepta lo que es inaceptable, se dice si cuando se quiere decir no), se envia un mensaje al propio cerebro de que las propias necesidades no son importantes, que erosiona gradualmente el sentido de merecimiento.

Brene Brown documenta que los límites son el fundamento de la compasión genuina: las personas que tienen límites claros son las que pueden dar con más generosidad, porque no dan desde el resentimiento sino desde una elección autentica.

**Ejercicio inmediato:** Identifica una situación actual donde estas aceptando algo que no quieres aceptar o cumpliendo un compromiso que asumiste sin querer. Diseña como comunicar un límite claro en esa situación esta semana. No de forma agresiva, pero si con claridad. El discomfort de ese límite es el precio de la autoestima que construye.

Cada vez que dices si cuando quieres decir no, le estas diciendo a tu cerebro que tus necesidades no importan lo suficiente.

---

## Capítulo 8: El error y la autoestima: como te tratas cuando te equivocas

Ruben se trata con una dureza extrema cuando comete errores. Esta dureza no produce aprendizaje más rápido ni mejor rendimiento futuro. Produce vergüenza que paraliza y bloquea la mejora.
...
## Capítulo 9: Autoestima y relaciones: la conexión que se retroalimenta
...
## Capítulo 10: Construir autoestima a largo plazo

Isabel no espera transformar su autoestima en una semana. Ha aceptado que es un trabajo de meses y años. Lo que ha cambiado es que ya sabe en que trabajar: no en decirse cosas buenas, sino en comportarse como alguien que se valora, un pequeño gesto a la vez.

**El Principio de la Autoestima como práctica Diaria, no como Estado Conseguido:** Nathaniel Branden concluye que la autoestima no es un logró definitivo sino una práctica continua. Los seis pilares no son cosas que se hacen una vez y ya estan. Son formas de relacionarse con uno mismo y con el mundo que requieren ejercicio repetido. La buena noticia es que el mismo mecanismo que construyo la baja autoestima (patrones repetidos de pensamiento y comportamiento que enviaron mensajes negativos sobre el propio valor) puede construir la alta autoestima: patrones repetidos de pensamiento y comportamiento que envan mensajes positivos y precisos sobre el propio valor.

El progreso en autoestima no es lineal ni dramatico. Es la acumulación de momentos donde se elige tratarse con un poco más de respeto, honestidad y cuidado de lo que se eligio ayer.

**Ejercicio inmediato:** Define un comportamiento específico que practicaras diariamente durante los próximos treinta dias como práctica de autoestima: puede ser un límite que mantendras, un cuidado físico que incorporaras, una acción que daras aunque tengas miedo, o una autocritica que remplazaras con un cuestionamiento más equilibrado. Un comportamiento, treinta dias, ejecutado con consistencia.

La autoestima no llega un dia de repente. Llega de la acumulación de dias donde te elegiste a ti mismo.
...
*Libro 21 de la colección psicología Aplicada, Libro 1 de 10 de Serie 03: Autoestima y Autoimagen.*
