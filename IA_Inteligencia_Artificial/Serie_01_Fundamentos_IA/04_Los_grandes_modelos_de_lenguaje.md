...
Rubén aprendió su lección. A partir de entonces, cuando pedía datos al modelo, siempre añadía la instrucción: "Si no tienes información verificada sobre esto, dímelo en lugar de inventar cifras." Una instrucción simple que cambio la calidad de sus outputs.
