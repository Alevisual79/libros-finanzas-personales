...
## Capítulo 2: GitHub Copilot — el estandar del sector
...
- Precio: Individual desde 10 dolares mes, Business desde 19 dolares usuario mes

---

## Capítulo 3: Alternativas a Copilot

**Cursor:** IDE completo (fork de VS Code) con IA profundamente integrada. Puede refactorizar ficheros completos y hacer cambios multi-archivo. Precio desde 20 dolares mes.

**Codeium:** Alternativa gratuita a Copilot con calidad comparable. Plugin para la mayoría de IDEs.

**Amazon CodeWhisperer:** Especialmente potente para desarrollo en AWS.

**Tabnine:** Foco en privacidad, puede ejecutarse localmente.

**Replit Ghostwriter:** Integrado en Replit, útil para principiantes.

---

## Capítulo 4: El impacto real en productividad
...
## Capítulo 5: El flujo de trabajo con programación asistida
...
**Para documentación:** Genera JSDoc o equivalente automáticamente.

**Para tests:** Genera tests unitarios como punto de partida, siempre revisados.
...
## Capítulo 7: IA para programadores no programadores

Con herramientas como ChatGPT, Claude o v0 (para interfaces web) o Bolt.new, personas sin experiencia formal pueden:
- Generar scripts de automatización para sus flujos de trabajo
- Crear dashboards de análisis basicos
- Automatizar tareas repetitivas
- Crear prototipos simples de sus ideas

Ruben, sin experiencia de programación formal, aprendió a generar scripts de Python para automatizar el procesamiento de sus datos de clientes.
...
## Capítulo 9: La IA reemplazara a los programadores?

La respuesta más honesta: cambiara el trabajo de los programadores, no los reemplazara en el corto plazo.

Lo que la evidencia actual sugiere:
- Los programadores junior que hacen trabajo rutinario tienen mayor exposición
- Los programadores senior que disenan arquitecturas tienen menor exposición
- Los programadores que aprenden a trabajar con IA son más productivos, no menos empleables

---

## Capítulo 10: El programador augmentado
...
La programación asistida esta haciendo el codigo más accesible. Como la imprenta hizo más accesible la escritura sin eliminar la necesidad de escritores con talento, la IA esta haciendo más accesible el codigo sin eliminar la necesidad de programadores con criterio.

---

*Este es el Libro 23 de la colección Inteligencia Artificial Aplicada, Libro 3 de 10 de la Serie 3: Herramientas de IA.*
